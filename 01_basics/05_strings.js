...
//console.log(`Hello my name is ${name} and my repo count is ${repoCount}.`)//This is new method with backticks(``).

//declaring string in other way
//try this code in web console and explore
/*
const gameName = 'RajanBhandari'//This line may be wrong .check it.
